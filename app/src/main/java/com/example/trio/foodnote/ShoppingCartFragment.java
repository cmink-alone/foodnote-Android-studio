...
public class ShoppingCartFragment extends Fragment {
    ...
    private Map<Integer, ArrayList<Ingredient>> data;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        data = ShoppingCartData.getData();

        view_empty = (RelativeLayout) getActivity().findViewById(R.id.shopping_empty);
        rv_shopping_cart = (RecyclerView) getActivity().findViewById(R.id.rv_shopping_cart);

        shoppingAdapter = new ShoppingListAdapter(getActivity(), data);
        rv_shopping_cart.setAdapter(shoppingAdapter);
        rv_shopping_cart.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
    }
